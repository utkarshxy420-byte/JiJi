...
Here's to some commemorative achievements:`,
    ...
    stats: {
      ...
      hours: { value: 175320, label: "Hours Logged" },
      seconds: { value: 631152000, label: "Seconds Clocked" },
      ...
      beAGoodFriend: { value: "lim(x→∞) (x⁴ + 3x² - 5x) / (x + 2)", label: "Be a good friend" },
      timesStronger: { value: "45.7", label: "Times you were stronger than anyone else" },
      daysMadeSense: { value: "3/365", label: "Days when you made sense" },
  ...
  {
    title: "Anyways",
        text: `<p>Putting all the bs aside. Making this was hella fun I can't even lie. The extra, the not enough, everything. Moreover, it forced me to elaborate you in words, which I must say, is both an easy and hard task. Easy because I have known you for long and well enough for however long you and I have talked, and hard because some aspects I can't quite put a handle on. But I tried to nonetheless. This was such a throwback to the time when I made you the chatroom stuff, and I had to learn, which I did very enthusiastically as it comes under my area of interest.</p>
          <p>Funfact, everytime I make a wish which include multiple files and information that is depicted/ or edited and made by images as a base, I make a folder on their name. I have a folder named "Goldie" which is now filled with canva and pinterest material I used for her wish, as well as some random downloads, files, screenshots, documents etcetra, which happened because of my lazyness to change the default location. Same with one named "Kaju" and now the newest addition being "Jia". You are now free to go continue with the rest of the wish on discord. Also the earlier vision of the site, was quite different from what it turned out, it was supposed to be more whimisy, more cutesy, and I suppose, matched the vibe. Instead of a professional corporate style, however, my dear friend, and also the supposed graphic designer of this site, otherwise known as goldie. Continued to give me false hope which never came. I stand, betrayed by my own kin shared braincell.</p>`,
    type: "text",
    content: ``
  }
];
